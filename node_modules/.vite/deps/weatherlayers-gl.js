...
import {
  ...
  picking_default,
  project32_default
} from "./chunk-FA75NTPP.js";
import {
  colorRampCanvas,
  parsePalette
} from "./chunk-DWCLB6OW.js";
import "./chunk-7VIXKTR5.js";
import {
  __commonJS,
  __toESM
...
var Q = "2025.11.0";
var y = "2025-11-16T21:46:37.022Z";
var b = /* @__PURE__ */ new Map();
function w(e, t) {
  b.set(e, t);
}
var x = { INWARD: "INWARD", OUTWARD: "OUTWARD" };
var T = { VALUE: "VALUE", CARDINAL: "CARDINAL", CARDINAL2: "CARDINAL2", CARDINAL3: "CARDINAL3" };
var M = { [T.CARDINAL]: ["N", "E", "S", "W"], [T.CARDINAL2]: ["N", "NE", "E", "SE", "S", "SW", "W", "NW"], [T.CARDINAL3]: ["N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW"] };
function O(e, t) {
...
function V(e, t, n) {
  if (t === x.OUTWARD && (e += 180), n === T.VALUE) return `${Math.round(e % 360)}°`;
  if (n === T.CARDINAL || n === T.CARDINAL2 || n === T.CARDINAL3) {
    const t2 = M[n], a = 360 / t2.length;
...
var U = 1;
var D = [255, 255, 255];
var N = '"Helvetica Neue", Arial, Helvetica, sans-serif';
var J = 12;
var L = [255, 255, 255];
var F = 1;
var Z = [13, 13, 13];
...
async function X(e, t) {
  const n = await (async function(e2) {
    ...
    try {
      if ("geotiff" === e2) return await import("./geotiff-F24KL4VC.js");
    } catch (t2) {
  ...
  let a;
  try {
    a = await n.fromUrl(e, { allowFullFile: true, blockSize: Number.MAX_SAFE_INTEGER, fetch: (e2, n2) => fetch(e2, { ...n2, headers: { ...n2?.headers, ...t?.headers } }) }, t?.signal);
  } catch (t2) {
    throw new Error(`Image ${e} can't be decoded.`, { cause: t2 });
  }
  const i = await a.getImage(0), o = await i.readRasters({ interleave: true, signal: t?.signal });
...
function j(e) {
  return async (t, n) => {
    ...
    const a = n?.cache ?? K, i = t + (n?.headers ? ":" + JSON.stringify(n?.headers) : ""), o = a.get(i);
    if (o) return o;
...
var H = j((async (e, t) => {
  if (e.includes(".png") || e.includes(".webp") || e.includes("image/png") || e.includes("image/webp")) return (async function(e2, t2) {
    let n;
    if (t2?.headers || t2?.signal) {
      const a2 = await fetch(e2, { headers: t2.headers, signal: t2.signal });
  ...
  if (e.includes(".tif") || e.includes("image/tif")) return X(e, t);
...
var oe = { NEAREST: "NEAREST", LINEAR: "LINEAR", CUBIC: "CUBIC" };
var re = { SCALAR: "SCALAR", VECTOR: "VECTOR" };
var Ae = { METRIC: "METRIC", METRIC_KILOMETERS: "METRIC_KILOMETERS", IMPERIAL: "IMPERIAL", NAUTICAL: "NAUTICAL" };
var se = { BOTTOM: "BOTTOM", TOP: "TOP", RIGHT: "RIGHT", LEFT: "LEFT" };
function le(e) {
  return e % 1;
}
function ce(e, t) {
...
function de(e, t, n) {
  return e.map(((a, i) => pe(e[i], t[i], n)));
}
function he(e, t) {
  return t ? e[3] >= 255 : !isNaN(e[0]);
}
function me(e, t, n) {
  return t === re.VECTOR ? n ? [pe(n[0], n[1], e[0] / 255), pe(n[0], n[1], e[1] / 255)] : [e[0], e[1]] : [NaN, NaN];
}
function Ce(e, t, n) {
  if (t === re.VECTOR) {
    const a = me(e, t, n);
  ...
  return (function(e2, t2, n2) {
    return t2 === re.VECTOR ? 0 : n2 ? pe(n2[0], n2[1], e2[0] / 255) : e2[0];
  })(e, t, n);
}
...
var ve = [3, -6, 0, 4].map(((e) => e / 6));
var fe = [-1, 6, -12, 8].map(((e) => e / 6));
function Ee(e) {
  return [e * e * e, e * e, e, 1];
}
function Be(e, t, n, a, i) {
  const o = ce(ce(ce(ge(e, ue(fe, Ee(i + 1))), ge(t, ue(ve, Ee(i)))), ge(n, ue(ve, Ee(1 - i)))), ge(a, ue(fe, Ee(2 - i))));
  return o[3] = e[3] > 0 && t[3] > 0 && n[3] > 0 && a[3] > 0 ? Math.max(Math.max(Math.max(e[3], t[3]), n[3]), a[3]) : 0, o;
}
function Qe(e, t, n, a, i) {
  return n === oe.CUBIC ? (function(e2, t2, n2, a2) {
    const i2 = n2 * t2[0] - 0.5, o = a2 * t2[1] - 0.5, r = Math.floor(i2), A2 = Math.floor(o), s = le(i2), l = le(o);
    return Be(Be(Ie(e2, t2, r, A2, -1, -1), Ie(e2, t2, r, A2, 0, -1), Ie(e2, t2, r, A2, 1, -1), Ie(e2, t2, r, A2, 2, -1), s), Be(Ie(e2, t2, r, A2, -1, 0), Ie(e2, t2, r, A2, 0, 0), Ie(e2, t2, r, A2, 1, 0), Ie(e2, t2, r, A2, 2, 0), s), Be(Ie(e2, t2, r, A2, -1, 1), Ie(e2, t2, r, A2, 0, 1), Ie(e2, t2, r, A2, 1, 1), Ie(e2, t2, r, A2, 2, 1), s), Be(Ie(e2, t2, r, A2, -1, 2), Ie(e2, t2, r, A2, 0, 2), Ie(e2, t2, r, A2, 1, 2), Ie(e2, t2, r, A2, 2, 2), s), l);
  })(e, t, a, i) : n === oe.LINEAR ? (function(e2, t2, n2, a2) {
    const i2 = n2 * t2[0] - 0.5, o = a2 * t2[1] - 0.5, r = Math.floor(i2), A2 = Math.floor(o), s = le(i2), l = le(o);
    return de(de(Ie(e2, t2, r, A2, 0, 0), Ie(e2, t2, r, A2, 1, 0), s), de(Ie(e2, t2, r, A2, 0, 1), Ie(e2, t2, r, A2, 1, 1), s), l);
  })(e, t, a, i) : (function(e2, t2, n2, a2) {
    const i2 = n2 * t2[0] - 0.5, o = a2 * t2[1] - 0.5;
    return Ie(e2, t2, Math.round(i2), Math.round(o), 0, 0);
  })(e, t, a, i);
}
function ye(e, t, n, a, i, o, r, A2) {
  const s = o ? r + 0.5 / n[0] : pe(0 + 0.5 / n[0], 1 - 0.5 / n[0], r), l = pe(0 + 0.5 / n[1], 1 - 0.5 / n[1], A2);
  if (t && i > 0) {
    return de(Qe(e, n, a, s, l), Qe(t, n, a, s, l), i);
  }
  return Qe(e, n, a, s, l);
}
function be(e, t, n) {
...
function Ve(e, t, n) {
  ...
  })(u, p, t), h = be(u, p, o), m = Pe(t), C = n.map(((e2) => {
    if (!(function(e3, t2) {
      return e3[0] >= t2[0] && e3[0] <= t2[2] && e3[1] >= t2[1] && e3[1] <= t2[3];
    })(e2, t)) return Se(e2, { value: NaN });
    const n2 = d(e2), o2 = n2[0] / u, C2 = n2[1] / p, I = ye(a, i, h, r, A2, m, o2, C2);
    if (!he(I, l)) return Se(e2, { value: NaN });
    const v = Ce(I, s, l);
    if ("number" == typeof c && !isNaN(c) && v < c || "number" == typeof g && !isNaN(g) && v > g) return Se(e2, { value: NaN });
    if (s === re.VECTOR) {
      const t2 = (function(e3, t3, n3) {
        if (t3 === re.VECTOR) {
          const a2 = me(e3, t3, n3);
          return (360 - (Math.atan2(a2[1], a2[0]) / Math.PI * 180 + 180) - 270) % 360;
        }
        return NaN;
      })(I, s, l);
      return Se(e2, { value: v, direction: t2 });
    }
    return Se(e2, { value: v });
  }));
  return { type: "FeatureCollection", features: C };
}
function Ue(e, t) {
  const { image: n, image2: a, imageSmoothing: i, imageInterpolation: o, imageWeight: r, imageType: A2, imageUnscale: s, imageMinValue: l, imageMaxValue: c } = e, { width: g, height: u } = n, p = o !== oe.NEAREST ? oe.NEAREST : o, d = be(g, u, i), h = Pe(t), m = new Float32Array(g * u);
  for (let e2 = 0; e2 < u; e2++) for (let t2 = 0; t2 < g; t2++) {
    const i2 = t2 + e2 * g, o2 = ye(n, a, d, p, r, h, t2 / g, e2 / u);
    if (!he(o2, s)) {
      m[i2] = NaN;
      continue;
    }
...
function Je(e, t) {
  const { data: n, width: a, height: i } = t, o = n.length / (a * i);
  if (n instanceof Uint8Array || n instanceof Uint8ClampedArray) {
    if (4 === o) return "rgba8unorm";
    if (2 === o) return "rg8unorm";
    if (1 === o) return "r8unorm";
    throw new Error("Unsupported data format");
  }
  if (n instanceof Float32Array) {
    if (!e.features.has("float32-renderable-webgl")) throw new Error("Float textures are required");
    if (2 === o) return "rg32float";
    if (1 === o) return "r32float";
    throw new Error("Unsupported data format");
  }
  throw new Error("Unsupported data format");
}
function Le(e, t, n = false) {
  const a = n ? De : Ne, i = a.get(e) ?? (() => {
    const t2 = /* @__PURE__ */ new WeakMap();
    return a.set(e, t2), t2;
  })();
  return i.get(t) ?? (() => {
    const a2 = e.createTexture({ format: Je(e, t), width: t.width, height: t.height, mipLevels: 1, sampler: { magFilter: "nearest", minFilter: "nearest", addressModeU: n ? "repeat" : "clamp-to-edge", addressModeV: "clamp-to-edge", lodMaxClamp: 0 } });
    return a2.copyImageData({ data: t.data, bytesPerRow: t.width }), i.set(t, a2), a2;
  })();
}
var Fe = null;
function Ze(e) {
  return Fe || (Fe = e.createTexture({ width: 1, height: 1, mipLevels: 1 }), Fe.copyImageData({ data: new Uint8Array([0, 0, 0, 0]) })), Fe;
}
var We = 6370972;
function qe(e, t) {
  return distance(e, t, We);
}
function ke(e, t, n) {
  return destinationPoint(e, t, n, We);
}
function Re(e) {
  return !!e.resolution;
}
...
function Xe(e) {
  const t = ze(e);
  return Math.max(qe(t, e.unproject([e.width / 2, 0])), qe(t, e.unproject([0, e.height / 2])), ...e.width > e.height ? [qe(t, e.unproject([e.width / 2 - e.height / 4 * 1, e.height / 2])), qe(t, e.unproject([e.width / 2 - e.height / 2 * 1, e.height / 2])), qe(t, e.unproject([e.width / 2 - e.height / 4 * 3, e.height / 2])), qe(t, e.unproject([e.width / 2 - e.height, e.height / 2]))] : [qe(t, e.unproject([e.width / 2, e.height / 2 - e.width / 4 * 1])), qe(t, e.unproject([e.width / 2, e.height / 2 - e.width / 2 * 1])), qe(t, e.unproject([e.width / 2, e.height / 2 - e.width / 4 * 3])), qe(t, e.unproject([e.width / 2, e.height / 2 - e.width]))]);
}
function je(e) {
  return (function(e2) {
    const t = e2[2] - e2[0] < 360 ? Oe(e2[0]) : we, n = e2[2] - e2[0] < 360 ? Oe(e2[2], t) : xe;
    return [t, Math.max(e2[1], Te), n, Math.min(e2[3], Me)];
  })(e.getBounds());
}
function He(e) {
  return Re(e) ? Math.log2(e.scale) : e.zoom;
}
function Ye(e, t) {
  return t * (Re(e) ? -1 : 1);
}
...
function $e(t, n) {
  const a = n.domain(), i = [a[0], a[a.length - 1]], o = colorRampCanvas(n), r = t.createTexture({ width: o.width, height: o.height, mipLevels: 1, sampler: { magFilter: "linear", minFilter: "linear", addressModeU: "clamp-to-edge", addressModeV: "clamp-to-edge" } });
  return r.copyExternalImage({ image: o }), { paletteBounds: i, paletteTexture: r };
}
function et(e) {
...
var nt = "uniform bitmap2Uniforms{vec4 A;bool B;float C;vec4 D;}bitmap2;const float E=512.;const float F=3.1415926536;const float G=E/F/2.;vec2 H(vec2 I){float J=I.x;float K=clamp(I.y,-89.9,89.9);return vec2(radians(J)+F,F+log(tan(F*0.25+radians(K)*0.5)))*G;}vec2 L(vec2 M){M/=G;return degrees(vec2(M.x-F,atan(exp(M.y-F))*2.-F*0.5));}vec4 N(vec3 O,float P){return mix(bitmap2.D,vec4(O,1.),P);}vec2 Q(vec2 R){return vec2((R.x-bitmap2.A[0])/(bitmap2.A[2]-bitmap2.A[0]),(R.y-bitmap2.A[3])/(bitmap2.A[1]-bitmap2.A[3]));}vec2 S(vec2 T,vec2 U){vec2 uv=T;if(bitmap2.C<-0.5){vec2 I=L(U);uv=Q(I);}else if(bitmap2.C>0.5){vec2 V=H(U);uv=Q(V);}return uv;}";
var at = "A";
var it = "B";
var ot = "C";
var rt = "D";
...
function gt(e) {
  const [t, n] = e, a = n * lt;
  return [ct * (t * lt + At) / (2 * At), ct * (At + Math.log(Math.tan(st + 0.5 * a))) / (2 * At)];
}
function ut(e = {}) {
  ...
  if (A2 !== i) {
    ...
    if (A2 === a && e2 === t) {
      const e3 = gt([r[0], r[1]]), t2 = gt([r[2], r[3]]);
      return { coordinateConversion: 1, bounds: [e3[0], e3[1], t2[0], t2[1]] };
    }
  }
  return { coordinateConversion: 0, bounds: r };
}
var pt = { name: "bitmap2", vs: nt, fs: nt, uniformTypes: { [at]: "vec4<f32>", [it]: "f32", [ot]: "f32", [rt]: "vec4<f32>" }, getUniforms: function(e = {}) {
  const { bounds: t, coordinateConversion: n } = ut(e);
  return { [at]: t, [it]: Pe(t) ? 1 : 0, [ot]: n, [rt]: e.transparentColor ? et(e.transparentColor) : [0, 0, 0, 0] };
} };
var dt = "uniform sampler2D W;uniform sampler2D X;uniform rasterUniforms{vec2 Y;float Z;float a;float b;float c;vec2 d;float e;float f;float g;float h;vec4 i;float j;float k;vec4 l;}raster;";
var ht = "W";
var mt = "X";
var Ct = "Y";
var It = "Z";
...
var Lt = class extends bitmap_layer_default {
  ...
  draw(e) {
    const { device: t, viewport: n } = this.context, { model: a } = this.state, { imageTexture: i, imageTexture2: o, imageSmoothing: r, imageInterpolation: A2, imageWeight: s, imageType: l, imageUnscale: c, imageMinValue: g, imageMaxValue: u, bounds: p, _imageCoordinateSystem: d, transparentColor: h, minZoom: m, maxZoom: C, borderEnabled: I, borderWidth: v, borderColor: f, gridEnabled: E, gridSize: B, gridColor: Q2 } = R(this.props, Jt), { paletteTexture: y2, paletteBounds: b2 } = this.state;
    if (!i) return;
    const w2 = Re(n);
    a && Ke(n, m, C) && (a.shaderInputs.setProps({ [pt.name]: { viewportGlobe: w2, bounds: p, _imageCoordinateSystem: d, transparentColor: h }, [Pt.name]: { imageTexture: i ?? Ze(t), imageTexture2: o ?? Ze(t), imageSmoothing: r, imageInterpolation: A2, imageWeight: s, imageType: l, imageUnscale: c, imageMinValue: g, imageMaxValue: u, borderEnabled: I, borderWidth: v, borderColor: f, gridEnabled: E, gridSize: B, gridColor: Q2 }, [Nt.name]: { paletteTexture: y2 ?? Ze(t), paletteBounds: b2 } }), this.props.image = i, super.draw(e), this.props.image = null);
  }
  _updatePalette() {
    const { device: e } = this.context, { palette: n } = R(this.props, Jt);
    if (!n) return void this.setState({ paletteTexture: void 0, paletteBounds: void 0 });
    const a = parsePalette(n), { paletteBounds: i, paletteTexture: o } = $e(e, a);
  ...
  _getRasterDirectionValue(e) {
    const { imageType: t } = R(this.props, Jt);
    return t === re.VECTOR ? e[1] / 255 * 360 : NaN;
  }
  getPickingInfo(e) {
    const t = super.getPickingInfo(e), { imageType: n } = R(this.props, Jt), { paletteBounds: a } = this.state;
    if (!t.color) return t;
    let i;
...
Lt.layerName = "RasterBitmapLayer", Lt.defaultProps = Jt;
var Ft = { ...Lt.defaultProps, imageTexture: void 0, imageTexture2: void 0, image: { type: "object", value: null }, image2: { type: "object", value: null }, bounds: { type: "array", value: [-180, -90, 180, 90], compare: true } };
var Zt = class extends composite_layer_default {
  renderLayers() {
    const { device: e } = this.context, { props: t, imageTexture: a, imageTexture2: i } = this.state;
    return t && a ? [new Lt(this.props, this.getSubLayerProps({ id: "bitmap", imageTexture: a, imageTexture2: i, _imageCoordinateSystem: COORDINATE_SYSTEM.LNGLAT, parameters: { cullMode: "back", depthCompare: "always", ...this.props.parameters }, image: Ze(e), image2: Ze(e) }))] : [];
  }
  updateState(e) {
...
var zt = class extends bitmap_layer_default {
  ...
  draw(e) {
    const { device: t, viewport: n } = this.context, { model: a } = this.state, { imageTexture: i, imageTexture2: o, imageSmoothing: r, imageInterpolation: A2, imageWeight: s, imageType: l, imageUnscale: c, imageMinValue: g, imageMaxValue: u, bounds: p, _imageCoordinateSystem: d, transparentColor: h, minZoom: m, maxZoom: C, color: I, interval: v, majorInterval: f, width: E } = R(this.props, Kt), { paletteTexture: B, paletteBounds: Q2 } = this.state;
    if (!i) return;
    const y2 = Re(n);
    a && Ke(n, m, C) && (a.shaderInputs.setProps({ [pt.name]: { viewportGlobe: y2, bounds: p, _imageCoordinateSystem: d, transparentColor: h }, [Pt.name]: { imageTexture: i ?? Ze(t), imageTexture2: o ?? Ze(t), imageSmoothing: r, imageInterpolation: A2, imageWeight: s, imageType: l, imageUnscale: c, imageMinValue: g, imageMaxValue: u }, [Nt.name]: { paletteTexture: B ?? Ze(t), paletteBounds: Q2, paletteColor: I }, [Gt.name]: { interval: v, majorInterval: f, width: E } }), this.props.image = i, super.draw(e), this.props.image = null);
  }
  _updatePalette() {
    const { device: e } = this.context, { palette: n } = R(this.props, Kt);
    if (!n) return void this.setState({ paletteTexture: void 0, paletteBounds: void 0 });
    const a = parsePalette(n), { paletteBounds: i, paletteTexture: o } = $e(e, a);
    this.setState({ paletteTexture: o, paletteBounds: i });
  }
};
zt.layerName = "ContourBitmapLayer", zt.defaultProps = Kt;
var Xt = { ...zt.defaultProps, imageTexture: void 0, imageTexture2: void 0, image: { type: "object", value: null }, image2: { type: "object", value: null } };
var jt = class extends composite_layer_default {
  renderLayers() {
    const { device: e } = this.context, { props: t, imageTexture: a, imageTexture2: i } = this.state;
    return t && a ? [new zt(this.props, this.getSubLayerProps({ id: "bitmap", imageTexture: a, imageTexture2: i, _imageCoordinateSystem: COORDINATE_SYSTEM.LNGLAT, parameters: { cullMode: "back", depthCompare: "always", ...this.props.parameters }, image: Ze(e), image2: Ze(e) }))] : [];
  }
  updateState(e) {
    const { image: t, image2: n, imageUnscale: a, bounds: i } = e.props;
    if (super.updateState(e), t && a && !(t.data instanceof Uint8Array || t.data instanceof Uint8ClampedArray)) throw new Error("imageUnscale can be applied to Uint8 data only");
...
jt.layerName = "ContourLayer", jt.defaultProps = Xt;
var Ht = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
function Yt(e = 20) {
  return new Array(e).fill(void 0).map((() => Ht.charAt(Math.floor(62 * Math.random())))).join("");
}
var _t = transform(($t = function() {
  ...
  function s(t2, n2 = globalThis, o2 = ["*"]) {
    n2.addEventListener("message", (function r2(A3) {
      ...
      const { id: c2, type: g2, path: u2 } = Object.assign({ path: [] }, A3.data), p2 = (A3.data.argumentList || []).map(v);
      let d2;
      try {
        ...
        switch (g2) {
          case "GET":
            ...
            break;
          case "SET":
            n3[u2.slice(-1)[0]] = v(A3.data.value), d2 = true;
            break;
          case "APPLY":
            d2 = a2.apply(n3, p2);
            break;
      ...
      Promise.resolve(d2).catch(((e2) => ({ value: e2, [i]: 0 }))).then(((e2) => {
        ...
        const [t3, a2] = I({ value: new TypeError("Unserializable return value"), [i]: 0 });
  ...
  function g(e2) {
    return f(e2, /* @__PURE__ */ new Map(), { type: "RELEASE" }).then((() => {
      l(e2);
    }));
  }
  ...
  function d(e2, a2, i2 = [], o2 = function() {
    ...
    const A3 = new Proxy(o2, { get(t2, o3) {
      ...
      if ("then" === o3) {
        ...
        const t3 = f(e2, a2, { type: "GET", path: i2.map(((e3) => e3.toString())) }).then(v);
      ...
      c(r2);
      const [A4, s2] = I(o3);
      return f(e2, a2, { type: "SET", path: [...i2, n2].map(((e3) => e3.toString())), value: A4 }, s2).then(v);
    }, apply(n2, o3, A4) {
      c(r2);
      const s2 = i2[i2.length - 1];
      if (s2 === t) return f(e2, a2, { type: "ENDPOINT" }).then(v);
      if ("bind" === s2) return d(e2, a2, i2.slice(0, -1));
      const [l2, g2] = h(A4);
      return f(e2, a2, { type: "APPLY", path: i2.map(((e3) => e3.toString())), argumentList: l2 }, g2).then(v);
    }, construct(t2, n2) {
      c(r2);
      const [o3, A4] = h(n2);
      return f(e2, a2, { type: "CONSTRUCT", path: i2.map(((e3) => e3.toString())), argumentList: o3 }, A4).then(v);
    } });
  ...
  function S2(e2, t2, n2) {
    return e2.map(((a2, i2) => P2(e2[i2], t2[i2], n2)));
  }
  function V2(e2, t2) {
  ...
  function U2(e2, t2, n2) {
    if (t2 === w2.VECTOR) {
      const a2 = (function(e3, t3, n3) {
        return t3 === w2.VECTOR ? n3 ? [P2(n3[0], n3[1], e3[0] / 255), P2(n3[0], n3[1], e3[1] / 255)] : [e3[0], e3[1]] : [NaN, NaN];
      })(e2, t2, n2);
      return Math.hypot(a2[0], a2[1]);
    }
    return (function(e3, t3, n3) {
      return t3 === w2.VECTOR ? 0 : n3 ? P2(n3[0], n3[1], e3[0] / 255) : e3[0];
    })(e2, t2, n2);
  }
  function D2(e2, t2, n2, a2, i2, o2) {
  ...
  const N2 = [3, -6, 0, 4].map(((e2) => e2 / 6)), J2 = [-1, 6, -12, 8].map(((e2) => e2 / 6));
  function L2(e2) {
    return [e2 * e2 * e2, e2 * e2, e2, 1];
  }
  function F2(e2, t2, n2, a2, i2) {
    const o2 = T2(T2(T2(M2(e2, O2(J2, L2(i2 + 1))), M2(t2, O2(N2, L2(i2)))), M2(n2, O2(N2, L2(1 - i2)))), M2(a2, O2(J2, L2(2 - i2))));
  ...
  function Z2(e2, t2, n2, a2, i2) {
    return n2 === b2.CUBIC ? (function(e3, t3, n3, a3) {
      ...
      return F2(F2(D2(e3, t3, r2, A3, -1, -1), D2(e3, t3, r2, A3, 0, -1), D2(e3, t3, r2, A3, 1, -1), D2(e3, t3, r2, A3, 2, -1), s2), F2(D2(e3, t3, r2, A3, -1, 0), D2(e3, t3, r2, A3, 0, 0), D2(e3, t3, r2, A3, 1, 0), D2(e3, t3, r2, A3, 2, 0), s2), F2(D2(e3, t3, r2, A3, -1, 1), D2(e3, t3, r2, A3, 0, 1), D2(e3, t3, r2, A3, 1, 1), D2(e3, t3, r2, A3, 2, 1), s2), F2(D2(e3, t3, r2, A3, -1, 2), D2(e3, t3, r2, A3, 0, 2), D2(e3, t3, r2, A3, 1, 2), D2(e3, t3, r2, A3, 2, 2), s2), l2);
    })(e2, t2, a2, i2) : n2 === b2.LINEAR ? (function(e3, t3, n3, a3) {
      const i3 = n3 * t3[0] - 0.5, o2 = a3 * t3[1] - 0.5, r2 = Math.floor(i3), A3 = Math.floor(o2), s2 = x2(i3), l2 = x2(o2);
      return S2(S2(D2(e3, t3, r2, A3, 0, 0), D2(e3, t3, r2, A3, 1, 0), s2), S2(D2(e3, t3, r2, A3, 0, 1), D2(e3, t3, r2, A3, 1, 1), s2), l2);
    })(e2, t2, a2, i2) : (function(e3, t3, n3, a3) {
      const i3 = n3 * t3[0] - 0.5, o2 = a3 * t3[1] - 0.5;
      return D2(e3, t3, Math.round(i3), Math.round(o2), 0, 0);
    })(e2, t2, a2, i2);
  }
  function W2(e2, t2, n2, a2, i2, o2, r2, A3) {
    const s2 = o2 ? r2 + 0.5 / n2[0] : P2(0 + 0.5 / n2[0], 1 - 0.5 / n2[0], r2), l2 = P2(0 + 0.5 / n2[1], 1 - 0.5 / n2[1], A3);
    return t2 && i2 > 0 ? S2(Z2(e2, n2, a2, s2, l2), Z2(t2, n2, a2, s2, l2), i2) : Z2(e2, n2, a2, s2, l2);
  }
  function q2(e2, t2) {
    ...
    for (let e3 = 0; e3 < u2; e3++) for (let t3 = 0; t3 < g2; t3++) {
      const i3 = t3 + e3 * g2, o3 = W2(n2, a2, d2, p2, r2, h2, t3 / g2, e3 / u2);
      if (!V2(o3, s2)) {
        m2[i3] = NaN;
        continue;
      }
      const C2 = U2(o3, A3, s2);
...
}, $t.toString().replace(/^function.+?{/, "").slice(0, -1)));
var $t;
var en = factory(_t);
var tn = { LOW: "L", HIGH: "H" };
var nn = wrap(en());
...
async function on(e, t, n) {
  const { image: a, image2: i, imageSmoothing: o, imageInterpolation: r, imageWeight: A2, imageType: s, imageUnscale: l, imageMinValue: c, imageMaxValue: g } = e, { data: u, width: p, height: d } = a, { data: m = null, width: C = null, height: I = null } = i || {}, v = u.slice(0), f = m ? m.slice(0) : null, E = (function(e2) {
    let t2 = 0;
    const n2 = [], a2 = e2[t2++];
    for (let i3 = 0; i3 < a2; i3++) {
      const a3 = [e2[t2++], e2[t2++]], i4 = e2[t2++];
      n2.push(an(a3, { type: tn.HIGH, value: i4 }));
    }
    const i2 = e2[t2++];
    for (let a3 = 0; a3 < i2; a3++) {
      const a4 = [e2[t2++], e2[t2++]], i3 = e2[t2++];
      n2.push(an(a4, { type: tn.LOW, value: i3 }));
    }
    return n2;
  })(await nn.getHighLowPointData(transfer(v, [v.buffer]), p, d, f ? transfer(f, [f.buffer]) : null, C, I, o, r, A2, s, l, c, g, t, n));
  return { type: "FeatureCollection", features: E };
}
var rn = "high-low-label";
function An(e, t, n) {
  return e.properties.type === tn.HIGH ? Math.round((e.properties.value - n) / n * 100) : Math.round((t - e.properties.value) / t * 100);
}
var sn = { image: { type: "object", value: null }, image2: { type: "object", value: null }, imageSmoothing: { type: "number", value: 0 }, imageInterpolation: { type: "object", value: oe.CUBIC }, imageWeight: { type: "number", value: 0 }, imageType: { type: "object", value: re.SCALAR }, imageUnscale: { type: "array", value: null }, imageMinValue: { type: "object", value: null }, imageMaxValue: { type: "object", value: null }, bounds: { type: "array", value: [-180, -90, 180, 90], compare: true }, minZoom: { type: "object", value: null }, maxZoom: { type: "object", value: null }, radius: { type: "number", value: 0 }, unitFormat: { type: "object", value: null }, textFormatFunction: { type: "function", value: W }, textFontFamily: { type: "object", value: N }, textSize: { type: "number", value: 12 }, textColor: { type: "color", value: L }, textOutlineWidth: { type: "number", value: 1 }, textOutlineColor: { type: "color", value: Z }, palette: { type: "object", value: null } };
var ln = class extends composite_layer_default {
  renderLayers() {
    ...
    const { unitFormat: r, textFormatFunction: A2, textFontFamily: s, textSize: c, textColor: g, textOutlineWidth: u, textOutlineColor: p } = R(t, sn), { paletteScale: d } = this.state;
    return [new text_layer_default(this.getSubLayerProps({ id: "type", data: n, getPixelOffset: [0, -Ye(e, 1.2 * c / 2)], getPosition: (e2) => e2.geometry.coordinates, getText: (e2) => e2.properties.type, getSize: 1.2 * c, getColor: (e2) => d ? tt(d(e2.properties.value).rgba()) : g, getAngle: _e(e, 0), outlineWidth: u, outlineColor: p, fontFamily: s, fontSettings: { sdf: true }, billboard: false, extensions: [new collision_filter_extension_default()], collisionEnabled: true, collisionGroup: rn, collisionTestProps: { sizeScale: 5 }, getCollisionPriority: (e2) => An(e2, a, i), parameters: { cullMode: "front", depthCompare: "always", ...this.props.parameters } })), new text_layer_default(this.getSubLayerProps({ id: "value", data: n, getPixelOffset: [0, Ye(e, 1.2 * c / 2)], getPosition: (e2) => e2.geometry.coordinates, getText: (e2) => A2(e2.properties.value, r), getSize: c, getColor: (e2) => d ? tt(d(e2.properties.value).rgba()) : g, getAngle: _e(e, 0), outlineWidth: u, outlineColor: p, fontFamily: s, fontSettings: { sdf: true }, billboard: false, extensions: [new collision_filter_extension_default()], collisionEnabled: true, collisionGroup: rn, collisionTestProps: { sizeScale: 5 }, getCollisionPriority: (e2) => An(e2, a, i), parameters: { cullMode: "front", depthCompare: "always", ...this.props.parameters } }))];
  }
  shouldUpdateState(e) {
    return super.shouldUpdateState(e) || e.changeFlags.viewportChanged;
  }
  updateState(e) {
    const { image: t, image2: n, imageSmoothing: a, imageInterpolation: i, imageWeight: o, imageType: r, imageUnscale: A2, imageMinValue: s, imageMaxValue: l, minZoom: c, maxZoom: g, radius: u, unitFormat: p, textFormatFunction: d, textFontFamily: h, textSize: m, textColor: C, textOutlineWidth: I, textOutlineColor: v, palette: f, visible: E } = e.props;
  ...
  async _updateFeatures() {
    const { image: e, image2: t, imageSmoothing: n, imageInterpolation: a, imageType: i, imageUnscale: o, imageMinValue: r, imageMaxValue: A2, imageWeight: s, bounds: l, radius: c } = R(this.props, sn);
    if (!e) return;
    const g = Yt();
    this.state.requestId = g;
    const u = { image: e, image2: t, imageSmoothing: n, imageInterpolation: a, imageWeight: s, imageType: i, imageUnscale: o, imageMinValue: r, imageMaxValue: A2 }, p = (await on(u, l, c)).features;
  ...
  _updateVisibleFeatures() {
    const { viewport: e } = this.context, { minZoom: t, maxZoom: n } = R(this.props, sn), { points: a } = this.state;
    if (!a) return;
    let i;
    i = Ke(e, t, n) ? a : [], this.setState({ visiblePoints: i });
  }
  _updatePalette() {
    const { palette: e } = R(this.props, sn);
...
ln.layerName = "HighLowCompositeLayer", ln.defaultProps = sn;
var cn = { ...ln.defaultProps };
var gn = class extends composite_layer_default {
  renderLayers() {
    const { props: e } = this.state;
    return e ? [new ln(this.props, this.getSubLayerProps({ id: "composite" }))] : [];
  }
  updateState(e) {
...
gn.layerName = "HighLowLayer", gn.defaultProps = cn;
var un = { COLD: "COLD", WARM: "WARM", OCCLUDED: "OCCLUDED", STATIONARY: "STATIONARY" };
var pn = { iconAtlas: "data:image/png;base64,", iconMapping: { COLD: { x: 2, y: 2, width: 50, height: 38, anchorY: 35, mask: true }, WARM: { x: 54, y: 2, width: 50, height: 38, anchorY: 35, mask: true } } };
function dn(e, t) {
  for (let n = e.length - 1; n >= 0; n--) if (t.call(e, e[n], n, e)) return n;
  return -1;
}
var hn = { data: { type: "array", value: [] }, minZoom: { type: "object", value: null }, maxZoom: { type: "object", value: null }, getType: { type: "function", value: null }, getPath: { type: "function", value: null }, width: { type: "number", value: 2 }, coldColor: { type: "color", value: [0, 0, 255] }, warmColor: { type: "color", value: [255, 0, 0] }, occludedColor: { type: "color", value: [148, 0, 211] }, iconSize: { type: "number", value: 15 }, _debug: { type: "boolean", value: false } };
var mn = class extends composite_layer_default {
  renderLayers() {
    const { viewport: e } = this.context, { props: t, visibleFrontLines: n, visibleDebugFrontPoints: a } = this.state;
    if (!t || !n || !a) return [];
    const { getType: i, getPath: s, width: g, coldColor: u, warmColor: p, occludedColor: d, iconSize: h, _debug: m } = R(t, hn);
    if (!i || !s) return [];
    const { iconStyle: C, iconAtlasTexture: I } = this.state;
    if (!C || !I) return [];
    const v = { [un.COLD]: u, [un.WARM]: p, [un.OCCLUDED]: d, [un.STATIONARY]: u };
    return [new path_layer_default(this.getSubLayerProps({ id: "path", data: n, getPath: (e2) => [e2.startPosition, ...e2.icons.map(((e3) => e3.position)), e2.endPosition], getColor: (e2) => v[i(e2.d)], getWidth: g, widthUnits: "pixels" })), new path_layer_default(this.getSubLayerProps({ id: "path-stationary-warm", data: n.filter(((e2) => i(e2.d) === un.STATIONARY)), getPath: (e2) => [e2.startPosition, ...e2.icons.map(((e3) => e3.position)), e2.endPosition], getColor: p, getWidth: g, widthUnits: "pixels", extensions: [new path_style_extension_default({ dash: true, highPrecisionDash: true })], getDashArray: [45, 45] })), new icon_layer_default(this.getSubLayerProps({ id: "icon", data: n.flatMap(((e2) => e2.icons)), getPosition: (e2) => e2.position, getIcon: (e2) => i(e2.d) === un.OCCLUDED || i(e2.d) === un.STATIONARY ? e2.alternate ? un.COLD : un.WARM : i(e2.d), getSize: h, getColor: (e2) => i(e2.d) === un.STATIONARY ? e2.alternate ? v[un.COLD] : v[un.WARM] : v[i(e2.d)], getAngle: (t2) => i(t2.d) === un.STATIONARY ? t2.alternate ? _e(e, t2.direction) : _e(e, t2.direction + 180) : _e(e, t2.direction), iconAtlas: I, iconMapping: C.iconMapping, sizeBasis: "height", billboard: false, extensions: [new collision_filter_extension_default()], collisionEnabled: true, collisionGroup: "front-icon", collisionTestProps: { sizeScale: 5 }, getCollisionPriority: (e2) => e2.priority })), ...m ? [new text_layer_default(this.getSubLayerProps({ id: "text", data: a, getPosition: (e2) => e2.position, getText: (e2) => `${e2.index}`, getSize: 12, getColor: L, getAngle: _e(e, 0), outlineWidth: 1, outlineColor: Z, fontFamily: N, fontSettings: { sdf: true }, billboard: false }))] : []];
  }
  shouldUpdateState(e) {
    return super.shouldUpdateState(e) || e.changeFlags.viewportChanged;
  }
  ...
  async _updateIconStyle() {
    ...
    this.setState({ iconStyle: pn });
    const t = Le(e, await H(pn.iconAtlas));
    this.setState({ iconAtlasTexture: t });
  }
  _updateFeatures() {
    const { data: e, getPath: t } = R(this.props, hn);
    if (!t) return;
    const n = e.map(((e2) => (function(e3, t2) {
      const n2 = t2, a2 = n2.slice(0, -1).map(((e4, t3) => qe(n2[t3], n2[t3 + 1]))).reduce(((e4, t3) => [...e4, e4[e4.length - 1] + t3]), [0]);
      let i = [];
      for (let e4 = 1, t3 = a2[a2.length - 1] / 3; t3 > 5e3; e4++, t3 /= 3) {
        const o2 = 3 ** e4;
        for (let r = 1; r < o2; r++) {
          if (e4 > 1 && r % 3 == 0) continue;
          const o3 = r * t3, A2 = dn(a2, ((e5) => e5 <= o3));
          if (-1 === A2 || A2 === n2.length - 1) throw new Error("Invalid state");
          const s = A2 + 1, l = n2[A2], c = n2[s], g = a2[A2], u = initialBearing(l, c), d = ke(l, o3 - g, u), h = 90 - u, m = 100 - e4;
          i.push({ distance: o3, position: d, direction: h, priority: m });
        }
      }
  ...
  _updateVisibleFeatures() {
    const { viewport: e } = this.context, { minZoom: t, maxZoom: n } = R(this.props, hn), { frontLines: a, debugFrontPoints: i } = this.state;
    if (!a || !i) return;
    let o, r;
    Ke(e, t, n) ? (o = a, r = i) : (o = [], r = []), this.setState({ visibleFrontLines: o, visibleDebugFrontPoints: r });
  }
};
mn.layerName = "FrontCompositeLayer", mn.defaultProps = hn;
var Cn = { ...mn.defaultProps };
var In = class extends composite_layer_default {
  renderLayers() {
    return [new mn(this.props, this.getSubLayerProps({ id: "composite" }))];
  }
};
In.layerName = "FrontLayer", In.defaultProps = Cn;
...
function En(e, t = 0) {
  ...
  if (Re(e)) {
    n = (function(e2, t2, n2) {
      ...
      return r;
    })(ze(e), Xe(e), Math.floor(He(e) + t + 1));
  } else {
    if (!Ge(e)) throw new Error("Invalid state");
    n = (function(e2, t2) {
...
bn.layerName = "GridCompositeLayer", bn.defaultProps = yn;
var wn = { ...bn.defaultProps };
var xn = class extends composite_layer_default {
  renderLayers() {
    const { props: e } = this.state;
    return e ? [new bn(this.props, this.getSubLayerProps({ id: "composite" }))] : [];
  }
  updateState(e) {
    const { image: t, imageUnscale: n } = e.props;
    if (super.updateState(e), t && n && !(t.data instanceof Uint8Array || t.data instanceof Uint8ClampedArray)) throw new Error("imageUnscale can be applied to Uint8 data only");
...
xn.layerName = "GridLayer", xn.defaultProps = wn;
var Tn = "uniform particleUniforms{float w;vec2 x;float y;vec4 z;float AA;float AB;float AC;float AD;float AE;float AF;}particle;";
var Mn = "w";
var On = "x";
var Pn = "y";
var Sn = "z";
...
var Jn = "AE";
var Ln = "AF";
var Fn = { name: "particle", vs: Tn, fs: Tn, uniformTypes: { [Mn]: "f32", [On]: "vec2<f32>", [Pn]: "f32", [Sn]: "vec4<f32>", [Vn]: "f32", [Un]: "f32", [Dn]: "f32", [Nn]: "f32", [Jn]: "f32", [Ln]: "f32" }, getUniforms: function(e = {}) {
  return { [Mn]: e.viewportGlobe ? 1 : 0, [On]: e.viewportGlobeCenter ?? [0, 0], [Pn]: e.viewportGlobeRadius ?? 0, [Sn]: e.viewportBounds ?? [0, 0, 0, 0], [Vn]: e.viewportZoomChangeFactor ?? 0, [Un]: e.numParticles, [Dn]: e.maxAge, [Nn]: e.speedFactor, [Jn]: e.time, [Ln]: e.seed };
} };
var Zn = "sourcePosition";
var Wn = "targetPosition";
var qn = "sourceColor";
var kn = "targetColor";
var Rn = { imageTexture: { type: "object", value: null }, imageTexture2: { type: "object", value: null }, imageSmoothing: { type: "number", value: 0 }, imageInterpolation: { type: "object", value: oe.CUBIC }, imageWeight: { type: "number", value: 0 }, imageType: { type: "object", value: re.VECTOR }, imageUnscale: { type: "array", value: null }, imageMinValue: { type: "object", value: null }, imageMaxValue: { type: "object", value: null }, bounds: { type: "array", value: [-180, -90, 180, 90], compare: true }, minZoom: { type: "object", value: null }, maxZoom: { type: "object", value: 15 }, palette: { type: "object", value: null }, color: { type: "color", value: D }, numParticles: { type: "number", min: 1, max: 1e6, value: 5e3 }, maxAge: { type: "number", min: 1, max: 255, value: 10 }, speedFactor: { type: "number", min: 0, max: 50, value: 1 }, width: { type: "number", value: 1 }, animate: true, wrapLongitude: true };
var Gn = class extends line_layer_default {
  getShaders() {
    const e = super.getShaders();
  ...
  updateState(e) {
    const { imageType: t, numParticles: n, maxAge: a, width: i, palette: o, visible: r } = e.props;
    super.updateState(e), r && t === re.VECTOR && n && a && i ? (t === e.oldProps.imageType && n === e.oldProps.numParticles && a === e.oldProps.maxAge && i === e.oldProps.width && r === e.oldProps.visible || this._setupTransformFeedback(), o !== e.oldProps.palette && this._updatePalette()) : this._deleteTransformFeedback();
  }
  finalizeState(e) {
  ...
  _runTransformFeedback() {
    ...
    if (!e) return;
    const { device: t, viewport: a, timeline: i } = this.context, { imageTexture: o, imageTexture2: r, imageSmoothing: A2, imageInterpolation: s, imageWeight: l, imageType: c, imageUnscale: g, imageMinValue: u, imageMaxValue: p, bounds: d, color: h, numParticles: m, maxAge: C, speedFactor: I } = R(this.props, Rn), { paletteTexture: v, paletteBounds: f, numAgedInstances: E, sourcePositions: B, targetPositions: Q2, sourceColors: y2, targetColors: b2, transform: w2, previousViewportZoom: x2, previousTime: T2 } = this.state;
    if (!(o && "number" == typeof E && B && Q2 && y2 && b2 && w2)) return;
    const M2 = i.getTime();
    if ("number" == typeof T2 && M2 < T2 + 1e3 / 30) return;
    const O2 = Re(a), P2 = Re(a) ? ze(a) : void 0, S2 = Re(a) ? Xe(a) : void 0, V2 = Ge(a) ? je(a) : void 0, U2 = 2 ** (4 * ("number" == typeof x2 ? x2 - He(a) : 0)), D2 = I / 2 ** (He(a) + 7);
    w2.model.shaderInputs.setProps({ [pt.name]: { viewportGlobe: O2, bounds: d, _imageCoordinateSystem: COORDINATE_SYSTEM.LNGLAT }, [Pt.name]: { imageTexture: o ?? Ze(t), imageTexture2: r ?? Ze(t), imageSmoothing: A2, imageInterpolation: s, imageWeight: l, imageType: c, imageUnscale: g, imageMinValue: u, imageMaxValue: p }, [Nt.name]: { paletteTexture: v ?? Ze(t), paletteBounds: f, paletteColor: h }, [Fn.name]: { viewportGlobe: O2, viewportGlobeCenter: P2, viewportGlobeRadius: S2, viewportBounds: V2, viewportZoomChangeFactor: U2, numParticles: m, maxAge: C, speedFactor: D2, time: M2, seed: Math.random() } }), w2.run({ clearColor: false, clearDepth: false, clearStencil: false, depthReadOnly: true, stencilReadOnly: true });
    const N2 = t.createCommandEncoder();
    N2.copyBufferToBuffer({ sourceBuffer: B, sourceOffset: 0, destinationBuffer: Q2, destinationOffset: 4 * m * 3, size: 4 * E * 3 }), N2.copyBufferToBuffer({ sourceBuffer: y2, sourceOffset: 0, destinationBuffer: b2, destinationOffset: 4 * m * 4, size: 4 * E * 4 });
    const J2 = N2.finish();
    t.submit(J2), N2.destroy(), this._swapTransformFeedback(), this.state.previousViewportZoom = He(a), this.state.previousTime = M2;
  }
  _swapTransformFeedback() {
    const { sourcePositions: e, targetPositions: t, sourceColors: n, targetColors: a, transform: i } = this.state;
    e && t && n && a && i && (this.state.sourcePositions = t, this.state.targetPositions = e, this.state.sourceColors = a, this.state.targetColors = n, i.model.setAttributes({ [Zn]: t, [qn]: a }), i.transformFeedback.setBuffers({ [Wn]: e, [kn]: n }));
  }
  ...
  _updatePalette() {
    const { device: e } = this.context, { palette: n } = R(this.props, Rn);
    if (!n) return void this.setState({ paletteTexture: void 0, paletteBounds: void 0 });
    const a = parsePalette(n), { paletteBounds: i, paletteTexture: o } = $e(e, a);
    this.setState({ paletteTexture: o, paletteBounds: i });
  }
...
Gn.layerName = "ParticleLineLayer", Gn.defaultProps = Rn;
var Kn = { ...Gn.defaultProps, imageTexture: void 0, imageTexture2: void 0, image: { type: "object", value: null }, image2: { type: "object", value: null } };
var zn = class extends composite_layer_default {
  renderLayers() {
    const { device: e } = this.context, { props: t, imageTexture: n, imageTexture2: a } = this.state;
    return t && n ? [new Gn(this.props, this.getSubLayerProps({ id: "line", data: [], imageTexture: n, imageTexture2: a, parameters: { cullMode: "front", depthCompare: "always", ...this.props.parameters }, image: Ze(e), image2: Ze(e) }))] : [];
  }
  updateState(e) {
    const { image: t, image2: n, imageUnscale: a, bounds: i } = e.props;
    if (super.updateState(e), t && a && !(t.data instanceof Uint8Array || t.data instanceof Uint8ClampedArray)) throw new Error("imageUnscale can be applied to Uint8 data only");
...
zn.layerName = "ParticleLayer", zn.defaultProps = Kn;
var Xn = class {
  addTo(e) {
...
var _n = class extends Xn {
  ...
  setConfig(n) {
    ...
    d.classList.add(Yn), d.innerHTML = `${o} [${P(r)}]`, p.appendChild(d);
    ...
    const I = document.createElementNS(m, "image");
    I.setAttribute("href", g), I.setAttribute("width", "100%"), I.setAttribute("height", "5"), I.setAttribute("preserveAspectRatio", "none"), C.appendChild(I);
    const v = (c[1] - c[0]) / (i - 1);
    for (let e = 0; e < i; e++) {
      const t = c[0] + e * v, n2 = O(t, r), a2 = document.createElementNS(m, "g");
...
var ia = class extends Xn {
  ...
  onAdd() {
    return this._container = document.createElement("div"), this._container.classList.add($n), this.setConfig(this._config), this._container;
  }
  onRemove() {
    this._container && this._container.parentNode && (this._container.parentNode.removeChild(this._container), this._container = void 0);
  }
  ...
  setConfig(e) {
    ...
    this._container.appendChild(t), this._value = document.createElement("span"), this._value.classList.add(ea), t.appendChild(this._value), this._direction = document.createElement("span"), this._direction.classList.add(ta), t.appendChild(this._direction), this._directionIcon = document.createElement("span"), this._directionIcon.classList.add(na), this._direction.appendChild(this._directionIcon), this._directionText = document.createElement("span"), this._directionText.classList.add(aa), this._direction.appendChild(this._directionText);
  }
  update(e) {
    if (!(this._container && this._value && this._directionIcon && this._directionText)) return;
    const { value: t, direction: n } = e ?? {};
    this._container.classList.toggle("follow-cursor", this._config.followCursor ?? false), this._container.setAttribute("data-follow-cursor-placement", this._config.followCursorPlacement ?? se.BOTTOM), this._container.classList.toggle("has-value", void 0 !== t), this._container.classList.toggle("has-direction", void 0 !== n), this._value.innerHTML = void 0 !== t ? S(t, this._config.unitFormat) : "", void 0 !== n ? (this._directionIcon.style.transform = `rotate(${(n + 180) % 360}deg)`, this._directionText.innerHTML = V(n, this._config.directionType ?? x.INWARD, this._config.directionFormat ?? T.VALUE)) : (this._directionIcon.style.transform = "", this._directionText.innerHTML = "");
  }
  updatePickingInfo(e) {
    ...
    if (this._config.followCursor) {
      const a = n.getBoundingClientRect(), i = this._value.getBoundingClientRect(), o = this._config.followCursorOffset ?? 16, r = this._config.followCursorPlacement ?? se.BOTTOM;
      let A2 = e.x, s = e.y;
      if (r === se.BOTTOM) s += o;
      else if (r === se.TOP) s -= o;
      else if (r === se.RIGHT) A2 += o;
      else {
        if (r !== se.LEFT) throw new Error(`Invalid placement ${r}`);
        A2 -= o;
      }
      if (this._container.style.left = `${A2}px`, this._container.style.top = `${s}px`, r === se.BOTTOM || r === se.TOP) {
...
var Ea = class extends Xn {
  ...
  async start() {
    !this._container || this._loading || this._running || (await this._preload(this._config.datetimes), this._animation.start(), this._container.classList.add(fa), this._updateProgress());
  }
  pause() {
    this._container && !this._loading && this._running && (this._animation.stop(), this._container.classList.remove(fa), this._updateProgress());
  }
  stop() {
    this._container && this._progressInput && !this._loading && this._running && (this._animation.stop(), this._container.classList.remove(fa), this._progressInput.valueAsNumber = 0, this._updateProgress());
  }
  reset() {
  ...
  _updateProgress() {
    ...
    const e = _(this._config.datetimes[Math.floor(this._progressInput.valueAsNumber)], this._config.datetimes[Math.ceil(this._progressInput.valueAsNumber)], this._progressInput.valueAsNumber % 1);
    this._config.datetime = e;
    const t = this._config.datetimeFormatFunction ?? ie;
  ...
  async _preload(e) {
    ...
    this._loading = true, this._container.classList.add(va);
    ...
    this._loading = false, this._container.classList.remove(va);
  }
  getConfig() {
    return { ...this._config };
  }
  setConfig(e) {
    ...
    this._config = e;
    const t = this._config.width ?? 300, n = this._config.datetimes, a = this._config.datetime, i = this._config.datetimeInterpolate ?? false, o = this._config.datetimeFormatFunction ?? ie, r = dn(n, ((e2) => e2 <= a));
    if (r < 0) throw new Error("Invalid state");
    const A2 = r < n.length - 1 ? r + 1 : null, s = $(n[r], "number" == typeof A2 ? n[r + 1] : null, a), l = i ? 0.25 : 1, c = r + Math.floor(s / l) * l;
    ...
    g.appendChild(u), this._currentDatetime = document.createElement("span"), this._currentDatetime.classList.add(ra), this._currentDatetime.innerHTML = o(a), u.appendChild(this._currentDatetime);
    ...
    C.classList.add(sa), C.innerHTML = o(n[0]), m.appendChild(C);
    const I = document.createElement("span");
    I.classList.add(la), m.appendChild(I);
    const v = document.createElement("span");
    v.classList.add(ca), v.innerHTML = o(n[n.length - 1]), m.appendChild(v);
    const f = document.createElement("a");
    f.href = "javascript:void(0)", f.classList.add(ga), f.classList.add(ua), f.addEventListener("click", (() => this.stepBackward())), I.appendChild(f);
    const E = document.createElement("a");
    E.href = "javascript:void(0)", E.classList.add(ga), E.classList.add(pa), E.addEventListener("click", (() => this.start())), I.appendChild(E);
    const B = document.createElement("a");
    B.href = "javascript:void(0)", B.classList.add(ga), B.classList.add(da), B.addEventListener("click", (() => this.pause())), I.appendChild(B);
    const Q2 = document.createElement("a");
    Q2.href = "javascript:void(0)", Q2.classList.add(ga), Q2.classList.add(ha), Q2.addEventListener("click", (() => this.stepForward())), I.appendChild(Q2);
    const y2 = document.createElement("span");
    y2.classList.add(ma), I.appendChild(y2);
    const b2 = document.createElement("span");
    b2.classList.add(Ca), y2.appendChild(b2), this._loaderText = document.createElement("span"), this._loaderText.classList.add(Ia), y2.appendChild(this._loaderText);
  }
};
jn(".weatherlayers-attribution-control{margin-top:2px;pointer-events:auto}.weatherlayers-attribution-control>div{background:hsla(0,0%,100%,.5);color:rgba(0,0,0,.75);display:inline-block;font-family:Helvetica Neue,Arial,Helvetica,sans-serif;font-size:12px;line-height:20px;padding:0 5px}.weatherlayers-attribution-control a{color:rgba(0,0,0,.75);text-decoration:none}.weatherlayers-attribution-control a:hover{text-decoration:underline}");
var Ba = class extends Xn {
  constructor(e = {}) {
    super(), this._container = void 0, this._config = e;
  }
  onAdd() {
...
export {
  G as Animation,
  Ba as AttributionControl,
  jt as ContourLayer,
  y as DATETIME,
  k as DEFAULT_ICON_COLOR,
  q as DEFAULT_ICON_SIZE,
  D as DEFAULT_LINE_COLOR,
  U as DEFAULT_LINE_WIDTH,
  L as DEFAULT_TEXT_COLOR,
  N as DEFAULT_TEXT_FONT_FAMILY,
  W as DEFAULT_TEXT_FORMAT_FUNCTION,
  Z as DEFAULT_TEXT_OUTLINE_COLOR,
  F as DEFAULT_TEXT_OUTLINE_WIDTH,
  J as DEFAULT_TEXT_SIZE,
  T as DirectionFormat,
  x as DirectionType,
  In as FrontLayer,
  un as FrontType,
  xn as GridLayer,
  ...
  se as Placement,
  Zt as RasterLayer,
  Ea as TimelineControl,
  ia as TooltipControl,
  Ae as UnitSystem,
  Q as VERSION,
  colorRampCanvas,
  R as ensureDefaultProps,
  ie as formatDatetime,
  V as formatDirection,
  P as formatUnit,
  O as formatValue,
  S as formatValueWithUnit,
  te as getClosestEndDatetime,
  ee as getClosestStartDatetime,
  $ as getDatetimeWeight,
  Ue as getRasterMagnitudeData,
  Ve as getRasterPoints,
  _ as interpolateDatetime,
  Y as loadJson,
  H as loadTextureData,
  ne as offsetDatetime,
  ae as offsetDatetimeRange,
  parsePalette,
  w as setLibrary
};
...
weatherlayers-gl/dist/weatherlayers-deck.min.js:
  (*!
