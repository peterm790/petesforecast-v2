...
addDecoder([8, 32946], () => import("./deflate-RAUOTJ6W.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-UPOPB7PA.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-NDAEQCDP.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-MIP2FQFM.js").then((module) => {
...
//# sourceMappingURL=geotiff-RTIYFPJL.js.map
